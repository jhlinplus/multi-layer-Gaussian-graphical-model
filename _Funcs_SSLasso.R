# ******************************************************
#
# Description: perform the de-biasing procedure;
...
#
#
pkgs = c("flare", "expm", "Matrix","glmnet");
...
# @@@@@@@@@@@@@@@@@@@@@@@@@
# Main function: Compute confidence intervals and p-values.
# @@@@@@@@@@@@@@@@@@@@@@@@@
...
#
  ...
  returnList <- list("noise.sd" = s.hat,
					 ...
					 "pvals" = 2*(1-pnorm(sqrt(n)*abs(unbiased.Lasso)/(s.hat*sqrt(diag(A[1:pp,1:pp])))))
					 )
  return(returnList)
}
